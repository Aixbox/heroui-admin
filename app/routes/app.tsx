  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-separator bg-background/80 px-4 backdrop-blur-lg sm:px-8">
          <div>
            <p className="text-sm text-muted">{location.pathname === "/app" ? "工作区概览" : "Acme Admin"}</p>
            <h1 className="text-lg font-semibold">欢迎回来，{user.name.split(" ")[0]}</h1>
          </div>
